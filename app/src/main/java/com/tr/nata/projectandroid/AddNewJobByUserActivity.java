...
public class AddNewJobByUserActivity extends AppCompatActivity {
...
//        et_id_kategori=view.findViewById(R.id.et_kategori_new);
        ...
        et_gaji_min.setText("");
        et_gaji_max.setText("");
        et_detail_pekerjaan.setText("");
        et_syarat_pekerjaan.setText("");
        et_syarat_cv.setText("");
...
//        });
        ...
        img_add_to_profille.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddNewJobByUserActivity.this,TryPerofilleActivity.class);
